...
*   Developers avoid writing lots of extra functionality that is not included in the specs because they engage in the spec-writing process first (enforces YAGNI - "you ain't gonna need it")
*   Ensure you have excellent test coverage because no application code is written without already written tests
...
*   [Wikipedia article on TDD](http://en.wikipedia.org/wiki/Test-driven_development)
*   [HN thread on TDD in the context of startups](http://news.ycombinator.com/item?id=2240595)
